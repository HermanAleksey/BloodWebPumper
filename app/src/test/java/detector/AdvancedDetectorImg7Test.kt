...
internal class AdvancedDetectorImg7Test {
    ...
    @Test
    fun `analyzeBloodWebPageState, img_7, assert level state`() {
        val testImageName = "img_7.png"
    ...
    @Test
    fun `processNodeStateQuality, img_7, process all nodes`() {
        val testImageName = "img_7.png"
        val bi = helper.getBufferedImageByFileName(testImageName)
